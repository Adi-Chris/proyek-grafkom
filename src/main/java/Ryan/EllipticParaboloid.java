...
public class EllipticParaboloid extends Object{
    ...
    float radiusY;
    float radiusZ;
    public EllipticParaboloid(List<ShaderProgram.ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, float centerX, float centerY, float centerZ, float radiusX, float radiusY, float radiusZ) {
